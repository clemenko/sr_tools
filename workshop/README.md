...
pdsh -l root -w $ipa,$ipb,$ipc 'tar -zvxf stackrox_all_3.0.58.1.tar.gz' | dshbak -c

# uncompress the smaller tars on all nodes
pdsh -l root -w $ipa,$ipb,$ipc 'cd stackrox_offline; tar -zxvf stackrox_offline_3.0.58.1.tgz; tar -zxvf image-collector-bundle_3.0.58.1.tgz' | dshbak -c
