...
pdsh -l root -w $ipa,$ipb,$ipc 'tar -zvxf stackrox_all_3.0.58.0.tar.gz' | dshbak -c

# uncompress the smaller tars on all nodes
pdsh -l root -w $ipa,$ipb,$ipc 'cd stackrox_offline; tar -zxvf stackrox_offline_3.0.58.0.tgz; tar -zxvf image-collector-bundle_3.0.58.0.tgz' | dshbak -c
